(function() {
    ...
    function StatusStatisticsController($scope, socket) {
        ...
        socket.on('call center status', (function(msg) {
            ...
            statusController.data = [
                statusController.statistics.by.status['AVAILABLE'] || 0,
                statusController.statistics.by.status['NOT AVAILABLE'] || 0,
                statusController.statistics.by.status['TALKING'] || 0,
                statusController.statistics.by.status['AFTER WORK'] || 0
            ];
